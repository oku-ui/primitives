...
const popoverContentModal = defineComponent({
  ...
  setup(props, { attrs, slots, emit }) {
    ...
    return () => h(OkuSlot, {}, () => h(OkuPopoverContentImpl, {
...
export const OkuPopoverContentModal = popoverContentModal as typeof popoverContentModal & (new () => { $props: PopoverContentTypeNaviteElement })
