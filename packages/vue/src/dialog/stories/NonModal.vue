  ...
  <div>
    <OkuDialog :modal="false">
      ...
      <OkuDialogPortal>
        ...
        <OkuDialogContent class="dialog-contentSheet" :on-interact-outside="(event) => event.preventDefault()">
          <OkuDialogTitle>
            Booking info
          </OkuDialogTitle>
    ...
    <div v-for="i in 5" :key="i" style="margin-top:20px">
      <textarea
        style="width: 800px; height: 400px;border: solid 1px;"
