  ...
  >
    ...
    <div :style="{ display: 'flex', gap: '30px' }">
      <HoverCardRoot>
        ...
        <HoverCardPortal>
          <HoverCardContent class="hoverCard_animatedContentClass" :side-offset="5">
        ...
        <HoverCardPortal>
          <HoverCardContent class="hoverCard_animatedContentClass" :side-offset="5">
            ...
            <HoverCardRoot>
              ...
              <!-- <HoverCardPortal> -->
              <HoverCardContent
                class="hoverCard_animatedContentClass"
                :side-offset="5"
                :style="{ backgroundColor: 'crimson' }"
              >
                <HoverCardArrow
                  class="hoverCard_arrowClass"
                  :width="20"
                  :height="10"
                  :style="{ fill: 'crimson' }"
                />
