...
// import type { MenuContentImplEmits, MenuContentImplNaviteElement } from './props'
...
//     const composedRefs = useComposedRefs(forwardedRef, contentRef, inject.onContentChange)
...
//     const ScrollLockWrapper = disableOutsideScroll ? RemoveScroll : Fragment
...
//             onMountAutoFocus: composeEventHandlers<MenuContentImplEmits['mountAutoFocus'][0]>((event) => {
//               // when opening, explicitly focus the content area only and leave
//               // `onEntryFocus` in  control of focusing first item
//               event.preventDefault()
//               contentRef.value?.focus()
//             }),
//             onUnmountAutoFocus: emit('closeAutoFocus'),
//           },
//           {
//             default: () => h(OkuDismissableLayer,
//               {
//                 asChild: true,
//                 disableOutsidePointerEvents: emit('disableOutsidePointerEvents'),
//                 onEscapeKeyDown: emit('escapeKeyDown'),
//                 onPointerDownOutside: emit('pointerDownOutside'),
//                 onFocusOutside: emit('focusOutside'),
//                 onInteractOutside: emit('interactOutside'),
...
//                     onCurrentTabStopIdChange: _currentItemId => currentItemId.value = _currentItemId,
...
//                             = target.closest('[data-oku-menu-content]') === event.valueTarget
...
//                           }
//                         }),
//                         'onPointerMove': composeEventHandlers<MenuContentImplEmits['pointermove'][0]>(whenMouse((event) => {
//                           const target = event.target as HTMLElement
