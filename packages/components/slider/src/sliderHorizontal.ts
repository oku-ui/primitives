...
import { OkuSliderImpl, type SliderImplElement, type SliderImplEmits, type SliderImplIntrinsicElement, type SliderImplProps, sliderImplPrivateProps, sliderImplProps } from './sliderImpl'
...
(new () => {
  $props: Partial<SliderHorizontalElement>
})
