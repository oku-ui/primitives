...
<template>
  <div>
    ...
    <h2 class="font-bold text-xl my-6">
      Default (700ms open, 300ms close)
    </h2>

    <OkuHoverCard>
      <OkuHoverCardTrigger href="/" class="hover_card_triggerClass underline">
        trigger
      </OkuHoverCardTrigger>
      <OkuHoverCardPortal>
        <OkuHoverCardContent class="hover_card_contentClass">
