  ...
  >
    <div style="display: flex; gap: 30px;">
      <OkuHoverCard>
        ...
        <OkuHoverCardPortal>
          <OkuHoverCardContent class="animatedContentClass" :side-offset="5">
        ...
        <OkuHoverCardPortal>
          <OkuHoverCardContent class="animatedContentClass" :side-offset="5">
            ...
            <OkuHoverCard>
              ...
              <OkuHoverCardPortal>
                <OkuHoverCardContent class="animatedContentClass" :side-offset="5" style="background-color: crimson">
                  <OkuHoverCardArrow class="arrowClass" :width="20" :height="10" style="fill: crimson" />
                  <div style="max-width: 400px;">
                  ...
                  <OkuHoverCard>
                    ...
                    <OkuHoverCardPortal>
                      <OkuHoverCardContent class="animatedContentClass" :side-offset="5" style="background-color: green">
                        <OkuHoverCardArrow class="arrowClass" :width="20" :height="10" style="fill: green" />
                        <div style="max-width: 400px;">
