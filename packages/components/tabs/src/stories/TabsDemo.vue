...
<template>
  <section>
    <div v-if="template === '#1' || allShow" class="mb-7">
      <h1>Horizontal (automatic activation)</h1>
      <OkuTabs default-value="tab1" class="root-class" data-test="tab1">
        <OkuTabList aria-label="tabs example" class="list-class">
          <OkuTabTrigger data-test="tab-one-trigger" value="tab1" class="trigger-class">
            Tab 1
          </OkuTabTrigger>
          <OkuTabTrigger value="tab2" disabled class="trigger-class" data-test="tab-two-trigger">
            Tab 2
          </OkuTabTrigger>
          <OkuTabTrigger value="tab3" class="trigger-class" data-test="tab-three-trigger">
            Tab 3
          </OkuTabTrigger>
        </OkuTabList>
        <OkuTabContent value="tab1" class="content-class" data-test="tab-one-content">
        ...
        <OkuTabContent value="tab2" class="content-class" data-test="tab-two-content">
          You'll never find me!
        </OkuTabContent>
        <OkuTabContent value="tab3" class="content-class" data-test="tab-three-content">
