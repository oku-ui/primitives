...
import type { FocusScopeProps } from '../focus-scope/index.ts'
...
import type { RovingFocusGroupRootEmits } from '../roving-focus/index.ts'
...
import { createContext, useBodyScrollLock, useRef } from '../hooks/index.ts'
...
import { getNextMatch, isPointerInGraceArea } from './utils.ts'
