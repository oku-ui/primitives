...
import { AccordionRoot, AccordionItem, ... } from "oku-primitives";
</script>
...
```vue{7}
<script setup lang="ts">
import { DropdownMenuRoot, DropdownMenuItem, ... } from "oku-primitives";
</script>
...
<script setup lang="ts">
import { AccordionItem, type AccordionItemProps } from "oku-primitives";
